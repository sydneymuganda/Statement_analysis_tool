...
const HMoneytransactions =()=>{
      ...
      const Chartdata2={
        ...
        datasets:[{
          ...
          data:[(data.agent_withdraw.average_amount_withdrawn),
            (data.agent_deposit.average_amount_deposited_via_agent)
    ...
    return(
       ...
       <table>
           ...
           <tr>
           <td> {dateSplicer(data.agent_deposit.last_time_deposited_via_agent)}</td>
           <td>{numberEdit(data.agent_deposit.maximum_amount_deposited_via_agent)}</td>
...
export default HMoneytransactions;